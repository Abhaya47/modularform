...
<div class="mfv-page">
      ...
      <div class="mfv-meta">
        ...
        <?php if ($form['closes'] && $form['closes_at']): ?>
          <span class="mfv-meta-text">
            <i class="ti ti-clock"
               aria-hidden="true"></i> Closes <?php print $closes_date; ?>
          </span>
        <?php endif; ?>
      </div>
    </div>
    <div class="mfv-topbar-actions">
      <a href="<?php print $form_url; ?>/preview" class="mfv-btn mfv-btn-sm"
         target="_blank">
      ...
      <div class="mfv-dropdown-wrap" id="mfv-actions-wrap">
        ...
        <div class="mfv-dropdown-menu" id="mfv-actions-menu" role="menu" hidden>
          <a href="<?php print $form_url; ?>/edit" role="menuitem"><i
              class="ti ti-edit" aria-hidden="true"></i> Edit form</a>
          <a href="<?php print $form_url; ?>/settings" role="menuitem"><i
              class="ti ti-settings" aria-hidden="true"></i> Settings</a>
          <a href="<?php print $form_url; ?>/members" role="menuitem"><i
              class="ti ti-users" aria-hidden="true"></i> Manage members</a>
          <a href="<?php print $form_url; ?>/invites" role="menuitem"><i
              class="ti ti-mail" aria-hidden="true"></i> Send invites</a>
          <a href="<?php print $form_url; ?>/export" role="menuitem"><i
              class="ti ti-download" aria-hidden="true"></i> Export
            responses</a>
          <a href="<?php print $form_url; ?>/delete" role="menuitem"
             class="mfv-danger"><i class="ti ti-trash" aria-hidden="true"></i>
            Delete form</a>
        </div>
      </div>
    </div>
  ...
  <div class="mfv-main-grid">
    ...
    <div class="mfv-card">
      <div class="mfv-card-head">
        <div class="mfv-card-head-left">
          <span class="mfv-card-icon mfv-ci-purple"><i class="ti ti-info-circle"
      ...
      <div class="mfv-card-body">
        <?php if (!empty($form['description'])): ?>
          <div class="mfv-info-row">
            <span class="mfv-info-label"><i class="ti ti-align-left"
                                            aria-hidden="true"></i> Description</span>
            <span
              class="mfv-info-value mfv-info-desc"><?php print check_markup($form['description']); ?></span>
          </div>
        <?php endif; ?>
        <div class="mfv-info-row">
          <span class="mfv-info-label"><i class="ti ti-calendar"
                                          aria-hidden="true"></i> Created</span>
          <span class="mfv-info-value"><?php print $created_date; ?></span>
        </div>
        <div class="mfv-info-row">
          <span class="mfv-info-label"><i class="ti ti-clock"
                                          aria-hidden="true"></i> Closes at</span>
        ...
        <div class="mfv-info-row">
          <span class="mfv-info-label"><i class="ti ti-calendar-event"
        ...
        <div class="mfv-info-row">
          <span class="mfv-info-label"><i class="ti ti-pencil"
                                          aria-hidden="true"></i> Editable responses</span>
          <span class="mfv-info-value">
        ...
        <div class="mfv-info-row">
          <span class="mfv-info-label"><i class="ti ti-ghost"
                                          aria-hidden="true"></i> Anonymous responses</span>
          <span class="mfv-info-value">
    ...
    <div class="mfv-side-col">
      ...
      <div class="mfv-card">
        <div class="mfv-card-head">
          <div class="mfv-card-head-left">
            <span class="mfv-card-icon mfv-ci-teal"><i class="ti ti-chart-pie"
                                                       aria-hidden="true"></i></span>
            <div><h3>Responses</h3>
              <p>Submitted vs pending</p></div>
          </div>
          <span
            class="mfv-badge mfv-badge-purple"><?php print $total; ?> total</span>
        </div>
        <div class="mfv-card-body">
          <div class="mfv-pie-area">
            <svg class="mfv-pie-svg" viewBox="0 0 120 120" aria-hidden="true">
              ...
              <text x="60" y="55" text-anchor="middle" font-size="16"
                    font-weight="500"
                    fill="var(--mfv-text-primary)"><?php print $submitted; ?></text>
            ...
            <div class="mfv-pie-legend">
              <div class="mfv-pie-legend-row">
                <span class="mfv-pie-label-group"><span class="mfv-pie-dot"
                                                        style="background:#534AB7"></span> Submitted</span>
                <span class="mfv-pie-count"><?php print $submitted; ?> <span
                    class="mfv-muted">(<?php print $pct; ?>%)</span></span>
              </div>
              <div class="mfv-pie-legend-row">
                <span class="mfv-pie-label-group"><span class="mfv-pie-dot"
                                                        style="background:#9FE1CB"></span> Pending</span>
                <span class="mfv-pie-count"><?php print $pending; ?> <span
                    class="mfv-muted">(<?php print (100 - $pct); ?>%)</span></span>
              </div>
            </div>
          </div>
          <div class="mfv-completion-wrap">
            <div class="mfv-completion-label">
              ...
              <span
                class="mfv-muted"><?php print $submitted; ?> of <?php print $total; ?> members</span>
            </div>
            <div class="mfv-completion-bar-track">
              <div class="mfv-completion-bar-fill"
                   style="width:<?php print $pct; ?>%"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mfv-card">
        <div class="mfv-card-head">
          <div class="mfv-card-head-left">
            <span class="mfv-card-icon mfv-ci-blue"><i
                class="ti ti-device-analytics" aria-hidden="true"></i></span>
            <div><h3>Quick stats</h3></div>
          </div>
        </div>
        <div class="mfv-card-body mfv-stats-grid">
          <div class="mfv-stat-mini">
            <div class="mfv-stat-label"><i class="ti ti-clock"
                                           aria-hidden="true"></i> Avg. time
            </div>
          ...
          <div class="mfv-stat-mini">
            ...
            <div class="mfv-stat-value"><?php print (int) $stats['notified']; ?>
              / <?php print $total; ?></div>
  ...
  <div class="mfv-analytics-grid">
    <div class="mfv-card">
      <div class="mfv-card-head">
        <div class="mfv-card-head-left">
          <span class="mfv-card-icon mfv-ci-blue"><i class="ti ti-chart-bar"
                                                     aria-hidden="true"></i></span>
  ...
  <!-- ===== ROW 3: Questions (full width) ===== -->
  <div class="mfv-analytics-grid">
    <div class="mfv-card">
      <div class="mfv-card-head">
        <div class="mfv-card-head-left">
          <span class="mfv-card-icon mfv-ci-purple"><i class="ti ti-list"
                                                       aria-hidden="true"></i></span>
          <div>
            <h3>Questions</h3>
  ...
  <!-- ===== ROW 4: Word cloud + Members side by side ===== -->
  <div class="mfv-bottom-grid">

    <div class="mfv-card">
      <div class="mfv-card-head">
        <div class="mfv-card-head-left">
          <span class="mfv-card-icon mfv-ci-amber"><i class="ti ti-tag"
                                                      aria-hidden="true"></i></span>
    ...
    <div class="mfv-card">
      <div class="mfv-card-head">
        <div class="mfv-card-head-left">
          <span class="mfv-card-icon mfv-ci-coral"><i class="ti ti-users"
                                                      aria-hidden="true"></i></span>
          <div><h3>Members</h3>
        ...
        foreach ($members as $m):
          ...
          <div class="mfv-member-row">
            ...
            <div class="mfv-member-info">
              ...
              <span
                class="mfv-member-role"><?php print $role_labels[$role]; ?></span>
            </div>
            <?php if ($role !== 0): ?>
              <span
                class="mfv-badge <?php print $member_status_classes[$mstatus]; ?>">
